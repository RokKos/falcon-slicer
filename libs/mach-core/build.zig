...
const gamemode = @import("../mach-gamemode/build.zig");
pub const gpu_dawn = @import("../mach-gpu-dawn/sdk.zig").Sdk(.{
    .glfw_include_dir = sdkPath("/libs/mach-glfw/upstream/glfw/include"),
    .system_sdk = system_sdk,
});
const gpu = @import("../mach-gpu/sdk.zig").Sdk(.{
    .gpu_dawn = gpu_dawn,
});
pub const core = @import("sdk.zig").Sdk(.{
    .gpu = gpu,
    .gpu_dawn = gpu_dawn,
    .glfw = glfw,
    .gamemode = gamemode,
